import { ScanLine, History, Settings, Users } from "lucide-react";

export type Tab = "scanner" | "history" | "settings" | "admin";
...
const BottomNav = ({ active, onChange, showAdmin }: BottomNavProps) => {
