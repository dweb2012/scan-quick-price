...
import { updateStockInSheet, syncEmplacementWithNotice, isCasB, sendCasB, sendCasA } from "@/lib/exportCasB";
...
const LocationEditor = ({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (!isCasB(product)) {
        sendCasA(product).catch((e) => console.warn("CAS A export failed", e));
      }
